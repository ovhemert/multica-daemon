...
### Changed
- Multica daemon CLI updated to `0.3.22`.
- CLI pins updated: Claude `2.1.178`, Codex `0.140.0`, Copilot `1.0.63`, OpenCode `1.17.7`, and Pi `0.79.4`.
...
[Unreleased]: https://github.com/ovhemert/multica-daemon/compare/v0.3.20...HEAD
