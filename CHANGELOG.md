...
### Changed
- Multica daemon CLI updated to `0.3.30`.
- CLI pins updated: Claude `2.1.193`, Codex `0.142.2`, Copilot `1.0.65`, Gemini `0.49.0`, Hermes `0.17.0`, OpenCode `1.17.11`, and Pi `0.80.2`.
...
[Unreleased]: https://github.com/ovhemert/multica-daemon/compare/v0.3.30...HEAD
[v0.3.30]: https://github.com/ovhemert/multica-daemon/compare/v0.3.26...v0.3.30
